...
int main(int argc, char **argv)
{
    ...
    bool is_correct1 = checkCorrect(output_d_0, output_host, batch_size, output_size);
    bool is_correct2 = checkCorrect(output_d_1, output_host, batch_size, output_size);
